...
def main():
    # 1. Load keys from the secure GitHub environment (UPDATED NAMES)
    ...
    """
    analyst_response = model.generate_content(analyst_prompt).text
    ...
    """
    final_prediction = model.generate_content(refiner_prompt).text
