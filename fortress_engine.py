...
from google import genai # 🔴 UPGRADED to the new 2026 library
...
class TitanMasterEngine:
    ...
    def ask_gemini(self, data):
        """Generates Model A's independent picks using the modern SDK."""
    ...
    def ask_llama3(self, data):
        ...
        try:
            ...
            r.raise_for_status() # Forces an error printout if it fails
    ...
    def execute_consensus_arbitrator(self, list_a, list_b):
        ...
        if not self.gemini_client: return "⚠️ Gemini API Key missing for Arbitrator."
        prompt = f"""
        ...
        try:
            ...
            # 🔴 This will now print the EXACT error instead of a generic failure message
